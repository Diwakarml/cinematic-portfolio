...
export default function PublicationsFooterSection() {
  ...
  useEffect(() => {
    ...
    let renderer, vidUni, rafId
    let onMouseMove = () => {}, onResize = () => {}

    if (!isMobile && canvas) {
      // ── Three.js: Diwakar's photo with Ken Burns cinematic animation ──
      ...
      loader.load('/assets/diwakar-photo.jpg', (imgTex) => {
    ...
    function onScroll() {
      ...
      if (isMobile) {
        ...
        // ── Phase 3: sine-eased crossfade image → Diwakar's photo canvas (p 0.65 → 0.92) ──
  ...
  return (
    <div ref={wrapperRef} className={styles.wrapper}>
      <div ref={stickyRef} className={styles.sticky}>
        ...
        {/* ── Diwakar's photo canvas (cinematic background - desktop) ── */}
